...
import { getVendorsQuery, getOrdersQuery, getListRequestsQuery, addPermintaanBarangMutation, addListRequestMutation} from '../queries/queries';
import {  
  Card, 
  CardBody, 
  CardHeader, 
...
class BuatPenyewaan extends Component {
  constructor(props){
    super(props);
    this.state = {
      orderItems: [],
        ...
        <Row>
          <Col>
            <Card>
              <CardHeader>
                Form Create Order
                <Link to="/penyewaan/penyewaan" className={'float-right mb-0'}>
