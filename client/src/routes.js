...
const routes = [
  ...
  { path: '/purchaseOrder/purchaseOrder', exact: true, name: 'Pembelian Barang', component: PurchaseOrder },
  { path: '/purchaseOrder/buatPurchaseOrder', exact: true, name: 'Buat Pembelian Barang', component: BuatPurchaseOrder },
  { path: '/purchaseOrder/detailPurchaseOrder/:id', exact: true, name: 'Detail Pembelian Barang', component: DetailPurchaseOrder },
